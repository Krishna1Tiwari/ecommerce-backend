...
const productschema = new mongoose.Schema({
  ...
  price: { type: Number, min: [0, 'wrong min price'], max: [1000000000, 'wrong max price'] },
  discountPercentage: { type: Number, min: [0, 'wrong min discount'], max: [99, 'wrong max dicount'] },
